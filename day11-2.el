...
(defun distance-between-galaxies (galaxy1 galaxy2 expanded-lines expanded-columns)
  (pcase-let* ((`(,x-galaxy1 . ,y-galaxy1) (col-and-line-at-pos-zero-indexed galaxy1))
               ...
               (x-expanded (* (--count (between? x-galaxy1 x-galaxy2 it) expanded-columns) 999999))
               (y-expanded (* (--count (between? y-galaxy1 y-galaxy2 it) expanded-lines) 999999))
...
;; (distance-between-galaxies 57 104 expanded-lines expanded-columns)))
